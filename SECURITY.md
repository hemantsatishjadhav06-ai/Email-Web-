...
We take the security of Mailwave and its self-hosted users seriously. Thank you
for helping keep Mailwave and its community safe.
...
1. **GitHub Private Vulnerability Reporting (preferred).** Go to the
   [Security tab](https://github.com/Mailwave/mailwave/security/advisories/new)
...
2. **Email.** Send the details to **hello@mailwave.com**.
...
- Run Mailwave behind a network egress policy where possible. Some features make
