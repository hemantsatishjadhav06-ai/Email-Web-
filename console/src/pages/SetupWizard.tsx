              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    {t`Your Mailwave instance has been successfully configured.`}
                  </p>
                </div>
                    ...
                    <div className="mt-12">
                      ...
                      {!configStatus.api_endpoint_configured && (
                        <Form.Item
                          ...
                          tooltip={t`Public URL where this Mailwave instance is accessible`}
                        >
                          <Input placeholder="https://mailwave.example.com" />
                        </Form.Item>
                      )}
                    </div>
                  )}
                            ...
                            <Row gutter={16}>
                              <Col span={12}>
                                <Form.Item
                                  ...
                                  tooltip={t`Help us improve Mailwave by sending anonymous usage statistics. No personal data or message content is collected.`}
                                >
                                  <Switch />
                                </Form.Item>
                              </Col>
                              <Col span={12}>
                                <Form.Item
                                  ...
                                  tooltip={t`Periodically check for new Mailwave versions and security updates. A popup will list new versions available.`}
                                >
                                  <Switch />
                                </Form.Item>
                              </Col>
