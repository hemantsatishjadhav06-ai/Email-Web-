...
export interface AmazonSES {
  ...
  /**
   * Managed tenant isolation: Mailwave provisions a tenant for this integration with its own
   * reputation profile and suppression list. Mutually exclusive with tenant_name.
   */
  tenant_isolation_enabled?: boolean

  /** Advanced: use a configuration set you manage instead of the one Mailwave creates. */
