...
describe('SignInPage', () => {
  ...
  it('auto-fills and submits email from URL parameter', async () => {
    ...
    (mockSearch as { email: string | undefined }).email = 'demo@mailwave.com'
    ...
    expect(screen.getByText(/demo@mailwave.com/i)).toBeInTheDocument()
  })
  ...
  describe('OIDC SSO', () => {
    ...
    it('extracts every OIDC error message into the source catalog', () => {
      ...
      const messages = [
        'No Mailwave account is linked to that identity. Ask an administrator to invite you first.',
