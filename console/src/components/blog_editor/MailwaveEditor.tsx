...
/**
 * Ref API for MailwaveEditor - allows parent components to retrieve content on-demand
 */
export interface MailwaveEditorRef {
...
export interface MailwaveEditorProps {
  placeholder?: string
...
export function EditorContentArea() {
  ...
  return (
    <EditorContent
      editor={editor}
      role="presentation"
      className="mailwave-editor-content"
      style={{
 ...
 */
export const EditorProvider = forwardRef<MailwaveEditorRef, EditorProviderProps>((props, ref) => {
  const { t } = useLingui()
  const {
  ...
  return (
    <div className="mailwave-editor-wrapper" style={editorStyles}>
 ...
 */
export const MailwaveEditor = forwardRef<MailwaveEditorRef, MailwaveEditorProps>(
  (
    {
...
MailwaveEditor.displayName = 'MailwaveEditor'
