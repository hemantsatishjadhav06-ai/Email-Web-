...
export function ImageNodeView(props: NodeViewProps) {
  ...
  const toolbarContent = (
    <div
      className="mailwave-editor-floating-toolbar-content"
      contentEditable={false}
      onMouseDown={(e) => e.stopPropagation()}
    >
      <div className="mailwave-editor-toolbar-section">
        <Tooltip title={t`Align left`}>
          <Button
            size="small"
            icon={
              <AlignLeft className="mailwave-editor-toolbar-icon" style={{ fontSize: '16px' }} />
            }
            type="text"
            onClick={(e) => {
              e.stopPropagation()
            ...
            onMouseDown={(e) => e.stopPropagation()}
            className={`mailwave-editor-toolbar-button ${
              align === 'left' ? 'mailwave-editor-toolbar-button-active' : ''
            }`}
          />
        </Tooltip>
        <Tooltip title={t`Align center`}>
          <Button
            size="small"
            icon={
              <AlignCenter className="mailwave-editor-toolbar-icon" style={{ fontSize: '16px' }} />
            }
            type="text"
            onClick={(e) => {
              e.stopPropagation()
            ...
            onMouseDown={(e) => e.stopPropagation()}
            className={`mailwave-editor-toolbar-button ${
              align === 'center' ? 'mailwave-editor-toolbar-button-active' : ''
            }`}
          />
        </Tooltip>
        <Tooltip title={t`Align right`}>
          <Button
            size="small"
            icon={
              <AlignRight className="mailwave-editor-toolbar-icon" style={{ fontSize: '16px' }} />
            }
            type="text"
            onClick={(e) => {
              e.stopPropagation()
            ...
            onMouseDown={(e) => e.stopPropagation()}
            className={`mailwave-editor-toolbar-button ${
              align === 'right' ? 'mailwave-editor-toolbar-button-active' : ''
            }`}
          />
        </Tooltip>
      </div>
      ...
      <div className="mailwave-editor-toolbar-section">
        <Tooltip title={t`Toggle caption`}>
          <Button
            ...
            icon={
              <MessageSquare
                className="mailwave-editor-toolbar-icon"
                style={{ fontSize: '16px' }}
              />
            }
            type="text"
            ...
            onMouseDown={(e) => e.stopPropagation()}
            className={`mailwave-editor-toolbar-button ${
              showCaption ? 'mailwave-editor-toolbar-button-active' : ''
            }`}
          />
        </Tooltip>
        ...
        >
          <Tooltip title={t`Edit alt text`}>
            <Button
              size="small"
              icon={
                <FileText className="mailwave-editor-toolbar-icon" style={{ fontSize: '16px' }} />
              }
              type="text"
              onClick={(e) => {
                e.stopPropagation()
              ...
              onMouseDown={(e) => e.stopPropagation()}
              className={`mailwave-editor-toolbar-button ${
                altValue ? 'mailwave-editor-toolbar-button-active' : ''
              }`}
            />
          </Tooltip>
        </Popover>
