    ...
    <Form.Item
      ...
      extra={
        isEditing
          ...
          : t`Names this connection in Mailwave, and the API key it creates in Settings → Team.`
      }
    >
      <Input
  ...
  const apiUrlCard = (
    <Card title={t`API URL`} className="!mb-6" size="small">
      <div className="text-gray-500 mb-2">
        {t`Paste this URL into the API URL field when you connect your Mailwave account in Zapier.`}
      </div>
    ...
    <>
      <div className="text-gray-600 mb-6">
        <Trans>
          ...
          your email provider. A Zap can also react to Mailwave events, such as
