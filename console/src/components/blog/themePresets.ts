      ...
      <div class="footer-content">
        <div class="footer-left">
          ...
          <p class="text-gray-500 text-xs mt-1">
            Powered by <a href="https://www.mailwave.com" target="_blank" rel="noopener" style="color: var(--color-link); text-decoration: none;">Mailwave</a>
          </p>
        </div>
        ...
        <div class="footer-links">
          ...
          <div class="social-links">
            <a href="https://www.mailwave.com" target="_blank" rel="noopener noreferrer" aria-label="Website">
