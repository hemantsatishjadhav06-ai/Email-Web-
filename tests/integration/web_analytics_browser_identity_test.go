...
<script>
  ...
  function whenReady(fn) {
    var tries = 0;
    (function poll() {
      var sdk = window.MailwaveAnalytics;
...
<script>window.MailwaveAnalyticsConfig={workspace_id:%q,endpoint:%q};</script>
<script async src="%s/na.js"></script>
</head><body style="font-family:sans-serif;padding:20px">
<h1>Mailwave Web Analytics — identify()</h1>
<script>
...
// runBrowserIdentifyToken exercises the credential Mailwave itself mints into a
...
<h1>Mailwave Web Analytics — nf_id</h1>
<script>
