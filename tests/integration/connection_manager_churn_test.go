...
import (
	...
	intdb "github.com/Mailwave/mailwave/internal/database"
	pgdb "github.com/Mailwave/mailwave/pkg/database"
...
// admin database. EnsureWorkspaceDatabaseExists is the only Mailwave code path
