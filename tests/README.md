# Integration Testing Framework for Mailwave API

This directory contains the integration testing framework for the Mailwave API, providing comprehensive end-to-end testing capabilities.
...
- **Default Sender**: noreply@mailwave.test
...
- `TEST_DB_USER` - Test database user (default: mailwave_test)
