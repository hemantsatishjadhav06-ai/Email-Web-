...
This directory contains GitHub Actions workflows for the Mailwave project.
...
4. The image will be available at `your-dockerhub-username/mailwave`
...
docker pull your-dockerhub-username/mailwave:latest

# Pull a specific version
docker pull your-dockerhub-username/mailwave:v1.2.3

# Run the container
docker run -p 8080:8080 your-dockerhub-username/mailwave:latest
```
