...
import (
	...
	http_handler "github.com/Mailwave/mailwave/internal/http"
	"github.com/Mailwave/mailwave/internal/service"
	pkgmocks "github.com/Mailwave/mailwave/pkg/mocks"
	mailwavemjml "github.com/Mailwave/mailwave/pkg/mailwave_mjml"
...
func createTestEmailTemplate() *domain.EmailTemplate {
	base := mailwavemjml.NewBaseBlock("root", mailwavemjml.MJMLComponentMjml)
	base.Attributes["version"] = "4.0.0"
	return &domain.EmailTemplate{
		SenderID:         "sender123",
		Subject:          "Test Email",
		CompiledPreview:  "<html><body>Test</body></html>",
		VisualEditorTree: &mailwavemjml.MJMLBlock{BaseBlock: base},
	}
}
...
func createTestRootBlockHandler(children ...mailwavemjml.EmailBlock) mailwavemjml.EmailBlock {
	base := mailwavemjml.NewBaseBlock("root", mailwavemjml.MJMLComponentMjml)
	base.Children = children
	base.Attributes["version"] = "4.0.0"
	return &mailwavemjml.MJMLBlock{BaseBlock: base}
}

func createTestTextBlockHandler(id, textContent string) mailwavemjml.EmailBlock {
	content := textContent
	base := mailwavemjml.NewBaseBlock(id, mailwavemjml.MJMLComponentMjText)
	base.Content = &content
	return &mailwavemjml.MJTextBlock{BaseBlock: base}
}
