...
const (
	...
	UserAgent = "Mailwave/1.0 DataFeedFetcher"
)

//go:generate mockgen -destination=./mocks/mock_data_feed_fetcher.go -package=mocks github.com/Mailwave/mailwave/internal/service/broadcast DataFeedFetcher
