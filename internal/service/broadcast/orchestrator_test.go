...
import (
	...
	"github.com/Mailwave/mailwave/internal/service/broadcast"
	"github.com/Mailwave/mailwave/internal/service/broadcast/mocks"
...
func createMinimalValidMJMLBlock(id string) *mailwave_mjml.MJMLBlock {
	bodyBase := mailwave_mjml.NewBaseBlock(id+"-body", mailwave_mjml.MJMLComponentMjBody)
	bodyBlock := &mailwave_mjml.MJBodyBlock{BaseBlock: bodyBase}

	rootBase := mailwave_mjml.NewBaseBlock(id, mailwave_mjml.MJMLComponentMjml)
				...
				template := &domain.Template{
					...
					Email: &domain.EmailTemplate{
						...
						VisualEditorTree: &mailwave_mjml.MJMLBlock{
							BaseBlock: mailwave_mjml.NewBaseBlock("root1", mailwave_mjml.MJMLComponentMjml),
						},
					},
				}
...
func TestBroadcastOrchestrator_Process_ABTestStartSetsTestingAndCompletesTestPhase(t *testing.T) {
	...
	// Template
	tpl := &domain.Template{ID: "template-1", Email: &domain.EmailTemplate{Subject: "S", SenderID: "s", VisualEditorTree: &mailwave_mjml.MJMLBlock{BaseBlock: mailwave_mjml.NewBaseBlock("root", mailwave_mjml.MJMLComponentMjml)}}}
...
func TestBroadcastOrchestrator_Process_ValidateTemplatesFailure(t *testing.T) {
	...
	badTpl := &domain.Template{ID: "tpl1", Email: &domain.EmailTemplate{SenderID: "s", VisualEditorTree: &mailwave_mjml.MJMLBlock{BaseBlock: mailwave_mjml.NewBaseBlock("root", mailwave_mjml.MJMLComponentMjml)}}}
...
func TestBroadcastOrchestrator_Process_BatchSizeZeroTriggersPhaseCompletion(t *testing.T) {
	...
	tpl := &domain.Template{ID: "tpl", Email: &domain.EmailTemplate{Subject: "s", SenderID: "x", VisualEditorTree: &mailwave_mjml.MJMLBlock{BaseBlock: mailwave_mjml.NewBaseBlock("root", mailwave_mjml.MJMLComponentMjml)}}}
...
func TestBroadcastOrchestrator_Process_AutoWinnerEvaluationPath(t *testing.T) {
	...
	tplB := &domain.Template{ID: "tplB", Email: &domain.EmailTemplate{Subject: "s", SenderID: "x", VisualEditorTree: &mailwave_mjml.MJMLBlock{BaseBlock: mailwave_mjml.NewBaseBlock("root", mailwave_mjml.MJMLComponentMjml)}}}
...
func TestBroadcastOrchestrator_ValidateTemplates_MissingContent(t *testing.T) {
	...
	emptyBase := mailwave_mjml.NewBaseBlock("", "")
	templates := map[string]*domain.Template{
		"template-1": {
			ID: "template-1",
			Email: &domain.EmailTemplate{
				Subject:          "Test Subject",
				SenderID:         "sender-1",
				VisualEditorTree: &mailwave_mjml.MJMLBlock{BaseBlock: emptyBase},
			},
		},
	}
	err := orchestrator.ValidateTemplates(templates)
