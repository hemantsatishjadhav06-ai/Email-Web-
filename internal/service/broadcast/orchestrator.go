...
//go:generate mockgen -destination=./mocks/mock_broadcast_orchestrator.go -package=mocks github.com/Mailwave/mailwave/internal/service/broadcast BroadcastOrchestratorInterface
