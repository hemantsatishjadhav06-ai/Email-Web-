...
func createQueueTestTextBlock(id, textContent string) mailwave_mjml.EmailBlock {
	content := textContent
...
func createQueueValidTestTree(textBlock mailwave_mjml.EmailBlock) mailwave_mjml.EmailBlock {
