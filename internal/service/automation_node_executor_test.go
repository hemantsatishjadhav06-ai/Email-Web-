...
func createTestTextBlock(id, content string) mailwave_mjml.EmailBlock {
	textBase := mailwave_mjml.NewBaseBlock(id, mailwave_mjml.MJMLComponentMjText)
	textBase.Content = &content
	return &mailwave_mjml.MJTextBlock{BaseBlock: textBase}
}

// createValidMJMLTree creates a valid MJML tree for testing
func createValidMJMLTree(textBlock mailwave_mjml.EmailBlock) mailwave_mjml.EmailBlock {
...
func TestEmailNodeExecutor_buildTrackingSettings_WebIdentityGate(t *testing.T) {
	...
	build := func(t *testing.T, webAnalytics *domain.WebAnalyticsSettings) mailwave_mjml.TrackingSettings {
		t.Helper()
	...
	assertBuiltWithoutIdentity := func(t *testing.T, settings mailwave_mjml.TrackingSettings) {
		t.Helper()
