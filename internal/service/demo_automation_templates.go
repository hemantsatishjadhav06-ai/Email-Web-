...
func (s *DemoService) createAutomationEmailMJMLStructure(c automationEmailContents) mailwave_mjml.EmailBlock {
	...
	headingBase := mailwave_mjml.NewBaseBlock("heading-text", mailwave_mjml.MJMLComponentMjText)
	...
	heading := &mailwave_mjml.MJTextBlock{BaseBlock: headingBase}
	...
	columnBase.Children = []mailwave_mjml.EmailBlock{heading, mainText, button, divider, footerText}
...
func (s *DemoService) demoAutomationTemplates(workspaceID string) []*domain.Template {
	...
	craMJMLStructures := map[string]mailwave_mjml.EmailBlock{
	...
	crbMJMLStructures := map[string]mailwave_mjml.EmailBlock{
	...
	otyMJMLStructures := map[string]mailwave_mjml.EmailBlock{
	...
	wboMJMLStructures := map[string]mailwave_mjml.EmailBlock{
