...
//go:generate mockgen -destination mocks/mock_federated_identity_repository.go -package mocks github.com/Mailwave/mailwave/internal/domain FederatedIdentityRepository

// FederatedIdentity links an external IdP subject to a Mailwave user. The durable
