...
//go:generate mockgen -destination mocks/mock_usage_service.go -package mocks github.com/Mailwave/mailwave/internal/domain UsageService
...
const (
	...
	// SECRET_KEY.
	usageKeyLabel = "mailwave.usage.v1"
