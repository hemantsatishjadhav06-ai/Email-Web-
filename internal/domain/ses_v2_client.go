...
//go:generate mockgen -destination mocks/mock_sesv2_client.go -package mocks github.com/Mailwave/mailwave/internal/domain SESv2Client

// SESv2Client is the SES API v2 surface Mailwave uses for sending and for tenant management.
...
// IsValidSESRegion reports whether region is one of the SES regions Mailwave supports.
...
// set associated": a suffix match would consider "prod-mailwave-abc" a match for "mailwave-abc".
