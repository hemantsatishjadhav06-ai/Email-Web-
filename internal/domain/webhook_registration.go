...
//go:generate mockgen -destination mocks/mock_webhook_registration_service.go -package mocks github.com/Mailwave/mailwave/internal/domain WebhookRegistrationService
