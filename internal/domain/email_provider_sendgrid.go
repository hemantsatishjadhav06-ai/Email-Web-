...
//go:generate mockgen -destination mocks/mock_sendgrid_service.go -package mocks github.com/Mailwave/mailwave/internal/domain SendGridServiceInterface
...
type SendGridWebhookEvent struct {
	...
	MailwaveMessageID string `json:"mailwave_message_id,omitempty"`
}
