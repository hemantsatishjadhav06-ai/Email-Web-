...
//go:generate mockgen -destination mocks/mock_ses_discovery_service.go -package mocks github.com/Mailwave/mailwave/internal/domain SESDiscoveryServiceInterface
