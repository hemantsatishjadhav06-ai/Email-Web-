...
import (
	...
	"github.com/Mailwave/mailwave/pkg/analytics"
)

//go:generate mockgen -destination mocks/mock_analytics_service.go -package mocks github.com/Mailwave/mailwave/internal/domain AnalyticsService
//go:generate mockgen -destination mocks/mock_analytics_repository.go -package mocks github.com/Mailwave/mailwave/internal/domain AnalyticsRepository

// PredefinedSchemas contains all available analytics schemas for Mailwave
