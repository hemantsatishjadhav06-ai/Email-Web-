...
//go:generate mockgen -destination mocks/mock_oidc_service.go -package mocks github.com/Mailwave/mailwave/internal/domain OIDCServiceInterface
...
// SSO identity has no matching Mailwave user and JIT provisioning is disabled.
var ErrOIDCAccountNotProvisioned = errors.New("no Mailwave account for this identity; ask to be invited")
