...
// Source: github.com/Mailwave/mailwave/internal/domain (interfaces: TemplateService)
...
import (
	...
	mailwave_mjml "github.com/Mailwave/mailwave/pkg/mailwave_mjml"
...
func (m *MockTemplateService) CompileTemplate(arg0 context.Context, arg1 mailwave_mjml.CompileTemplateRequest) (*mailwave_mjml.CompileTemplateResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CompileTemplate", arg0, arg1)
	ret0, _ := ret[0].(*mailwave_mjml.CompileTemplateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
