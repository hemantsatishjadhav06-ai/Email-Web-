...
//go:generate mockgen -destination mocks/mock_notification_center_service.go -package mocks github.com/Mailwave/mailwave/internal/domain NotificationCenterService
