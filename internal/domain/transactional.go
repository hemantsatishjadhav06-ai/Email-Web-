...
//go:generate mockgen -destination mocks/mock_transactional_notification_service.go -package mocks github.com/Mailwave/mailwave/internal/domain TransactionalNotificationService
//go:generate mockgen -destination mocks/mock_transactional_notification_repository.go -package mocks github.com/Mailwave/mailwave/internal/domain TransactionalNotificationRepository
...
type TransactionalNotificationUpdateParams struct {
	...
	TrackingSettings mailwave_mjml.TrackingSettings `json:"tracking_settings,omitempty"`
	Metadata         MapOfAny                       `json:"metadata,omitempty"`
...
func (req *CreateTransactionalRequest) Validate() error {
	...
	if err := mailwave_mjml.ValidateTrackingMode(req.Notification.TrackingSettings.TrackingMode); err != nil {
...
func (req *UpdateTransactionalRequest) Validate() error {
	...
	if err := mailwave_mjml.ValidateTrackingMode(req.Updates.TrackingSettings.TrackingMode); err != nil {
		return NewValidationError(err.Error())
	}
