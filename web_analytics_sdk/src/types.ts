...
// Global window declaration for MailwaveAnalyticsConfig
declare global {
  interface Window {
...
// Configuration
export interface MailwaveAnalyticsConfig {
  // Required
  workspace_id: string;
  endpoint: string;
...
export interface InternalConfig extends Required<Omit<MailwaveAnalyticsConfig, 'workspace_id' | 'endpoint' | 'heartbeatTiers' | 'crossDomains' | 'crossDomainExpiry' | 'crossDomainStripParams' | 'crossDomainParam' | 'extraAdClickIds'>> {
...
// Public API
export interface MailwaveAnalyticsAPI {
