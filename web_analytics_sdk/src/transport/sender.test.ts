  ...
  describe('debug mode', () => {
    ...
    it('logs sendSession payload in debug mode', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[MailwaveAnalytics] Sending session payload:',
        expect.any(Object)
      );
    });
    ...
    it('logs sendSession response in debug mode', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[MailwaveAnalytics] Session response:',
    ...
    it('logs beacon send in debug mode', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[MailwaveAnalytics] Sending session beacon:',
        expect.any(Object)
      );
      expect(console.log).toHaveBeenCalledWith(
        '[MailwaveAnalytics] Session sent via beacon'
      );
    });
    ...
    it('logs fetch fallback in debug mode', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[MailwaveAnalytics] Session sent via fetch keepalive'
      );
    });
  });
  ...
  describe('fetchLater progressive enhancement', () => {
    ...
    it('logs fetchLater usage in debug mode', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        '[MailwaveAnalytics] Session queued via fetchLater'
      );
