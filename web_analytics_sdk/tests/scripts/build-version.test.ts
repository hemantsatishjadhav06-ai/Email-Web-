...
describe('SDK build version injection', () => {
  ...
  // Read the expected version from config/config.go
  ...
  it('should inject version into UMD bundle (mailwave-analytics.min.js)', () => {
    const bundlePath = path.join(sdkDistPath, 'mailwave-analytics.min.js');
  ...
  it('should inject version into ESM bundle (mailwave-analytics.esm.js)', () => {
    const bundlePath = path.join(sdkDistPath, 'mailwave-analytics.esm.js');
  ...
  it('should inject version into CJS bundle (mailwave-analytics.cjs.js)', () => {
    const bundlePath = path.join(sdkDistPath, 'mailwave-analytics.cjs.js');
  ...
  it('should have consistent version across all bundles', () => {
    const expectedVersion = getExpectedVersion();
    const bundles = ['mailwave-analytics.min.js', 'mailwave-analytics.esm.js', 'mailwave-analytics.cjs.js'];
