...
export type { MailwaveAnalyticsAPI } from '../../src/types';

// Declare global types for browser context.
// Window.MailwaveAnalyticsConfig and Window.chrome are already augmented by the
...
declare global {
  ...
  const MailwaveAnalytics: import('../../src/types').MailwaveAnalyticsAPI;
}
