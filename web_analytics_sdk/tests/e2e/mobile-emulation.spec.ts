...
test.describe('Mobile Emulation', () => {
  ...
  test('handles touch scroll events', async ({ page }) => {
    ...
    await page.evaluate(() => MailwaveAnalytics.trackGoal({ action: 'scroll_check', type: 'other' }));
    await page.waitForTimeout(500);
  ...
  test('handles freeze event (background app)', async ({ page }) => {
    ...
    await page.evaluate(() => MailwaveAnalytics.trackGoal({ action: 'freeze_check', type: 'other' }));
    await page.waitForTimeout(500);
  ...
  test('touch scroll updates scroll in current_page', async ({ page }) => {
    ...
    await page.evaluate(() => MailwaveAnalytics.trackGoal({ action: 'scroll_final', type: 'other' }));
    await page.waitForTimeout(500);
