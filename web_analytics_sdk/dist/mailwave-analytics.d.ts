...
interface InternalConfig extends Required<Omit<MailwaveAnalyticsConfig, 'workspace_id' | 'endpoint' | 'heartbeatTiers' | 'crossDomains' | 'crossDomainExpiry' | 'crossDomainStripParams' | 'crossDomainParam' | 'extraAdClickIds'>> {
 ...
 * email link carried an opaque token Mailwave minted. Both are checked against
...
interface MailwaveAnalyticsAPI {
    init(config: MailwaveAnalyticsConfig): Promise<void>;
...
export type { GoalData, MailwaveAnalyticsAPI, MailwaveAnalyticsConfig, SessionDebugInfo };
