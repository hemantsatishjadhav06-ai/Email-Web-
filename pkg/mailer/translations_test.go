...
func TestGetTranslations_PerLocale(t *testing.T) {
	cases := []struct {
		...
		{"en", "Your Mailwave authentication code"},
		{"fr", "Votre code d'authentification Mailwave"},
		{"es", "Tu código de autenticación de Mailwave"},
		{"de", "Ihr Mailwave-Authentifizierungscode"},
		{"ca", "El teu codi d'autenticació de Mailwave"},
		{"pt-BR", "Seu código de autenticação da Mailwave"},
		{"ja", "Mailwave 認証コード"},
		{"it", "Il tuo codice di autenticazione Mailwave"},
	}
