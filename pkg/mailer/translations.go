...
type CommonStrings struct {
	...
	TeamName string // signature team name, e.g. "The Mailwave Team"
}
...
var englishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hello,",
		TeamName: "The Mailwave Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Your Mailwave authentication code",
		Heading:      "Your authentication code",
		Intro:        "Your authentication code for Mailwave is:",
		Expiry:       "The code will expire in 10 minutes.",
		IgnoreNotice: "If you did not request this code, please ignore this email.",
		SignOff:      "Thanks,",
	},
	Invitation: InvitationStrings{
		Subject:     "You've been invited to join %s on Mailwave",
		Heading:     "You've been invited to join Mailwave!",
		Body:        "%[1]s has invited you to join the %[2]s workspace on Mailwave.",
...
var frenchTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Bonjour,",
		TeamName: "L'équipe Mailwave",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Votre code d'authentification Mailwave",
		Heading:      "Votre code d'authentification",
		Intro:        "Votre code d'authentification pour Mailwave est :",
		Expiry:       "Ce code expirera dans 10 minutes.",
		IgnoreNotice: "Si vous n'avez pas demandé ce code, veuillez ignorer cet e-mail.",
		SignOff:      "Merci,",
	},
	Invitation: InvitationStrings{
		Subject:     "Vous avez été invité à rejoindre %s sur Mailwave",
		Heading:     "Vous avez été invité à rejoindre Mailwave !",
		Body:        "%[1]s vous a invité à rejoindre l'espace de travail %[2]s sur Mailwave.",
...
var spanishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "El equipo de Mailwave",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Tu código de autenticación de Mailwave",
		Heading:      "Tu código de autenticación",
		Intro:        "Tu código de autenticación para Mailwave es:",
		Expiry:       "El código caducará en 10 minutos.",
		IgnoreNotice: "Si no solicitaste este código, ignora este correo electrónico.",
		SignOff:      "Gracias,",
	},
	Invitation: InvitationStrings{
		Subject:     "Te han invitado a unirte a %s en Mailwave",
		Heading:     "¡Te han invitado a unirte a Mailwave!",
		Body:        "%[1]s te ha invitado a unirte al espacio de trabajo %[2]s en Mailwave.",
...
var germanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hallo,",
		TeamName: "Das Mailwave-Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Ihr Mailwave-Authentifizierungscode",
		Heading:      "Ihr Authentifizierungscode",
		Intro:        "Ihr Authentifizierungscode für Mailwave lautet:",
	...
	Invitation: InvitationStrings{
		Subject:     "Sie wurden eingeladen, %s auf Mailwave beizutreten",
		Heading:     "Sie wurden zu Mailwave eingeladen!",
		Body:        "%[1]s hat Sie eingeladen, dem Workspace %[2]s auf Mailwave beizutreten.",
...
var catalanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "L'equip de Mailwave",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "El teu codi d'autenticació de Mailwave",
		Heading:      "El teu codi d'autenticació",
		Intro:        "El teu codi d'autenticació per a Mailwave és:",
		Expiry:       "El codi caducarà en 10 minuts.",
		IgnoreNotice: "Si no has sol·licitat aquest codi, ignora aquest correu electrònic.",
		SignOff:      "Gràcies,",
	},
	Invitation: InvitationStrings{
		Subject:     "T'han convidat a unir-te a %s a Mailwave",
		Heading:     "T'han convidat a unir-te a Mailwave!",
		Body:        "%[1]s t'ha convidat a unir-te a l'espai de treball %[2]s a Mailwave.",
...
var portugueseBRTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Olá,",
		TeamName: "A equipe da Mailwave",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Seu código de autenticação da Mailwave",
		Heading:      "Seu código de autenticação",
		Intro:        "Seu código de autenticação para a Mailwave é:",
		Expiry:       "O código expirará em 10 minutos.",
		IgnoreNotice: "Se você não solicitou este código, ignore este e-mail.",
		SignOff:      "Obrigado,",
	},
	Invitation: InvitationStrings{
		Subject:     "Você foi convidado para participar de %s na Mailwave",
		Heading:     "Você foi convidado para participar da Mailwave!",
		Body:        "%[1]s convidou você para participar do espaço de trabalho %[2]s na Mailwave.",
...
var japaneseTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "こんにちは、",
		TeamName: "Mailwave チーム",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Mailwave 認証コード",
		Heading:      "認証コード",
		Intro:        "Mailwave の認証コードは次のとおりです:",
		Expiry:       "このコードは10分後に有効期限が切れます。",
		IgnoreNotice: "このコードをリクエストしていない場合は、このメールを無視してください。",
		SignOff:      "よろしくお願いいたします、",
	},
	Invitation: InvitationStrings{
		Subject:     "%s に参加するよう招待されました（Mailwave）",
		Heading:     "Mailwave への参加に招待されました！",
		Body:        "%[1]s さんが、Mailwave のワークスペース %[2]s への参加にあなたを招待しました。",
...
var italianTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Ciao,",
		TeamName: "Il team di Mailwave",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Il tuo codice di autenticazione Mailwave",
		Heading:      "Il tuo codice di autenticazione",
		Intro:        "Il tuo codice di autenticazione per Mailwave è:",
		Expiry:       "Il codice scadrà tra 10 minuti.",
		IgnoreNotice: "Se non hai richiesto questo codice, ignora questa email.",
		SignOff:      "Grazie,",
	},
	Invitation: InvitationStrings{
		Subject:     "Sei stato invitato a unirti a %s su Mailwave",
		Heading:     "Sei stato invitato a unirti a Mailwave!",
		Body:        "%[1]s ti ha invitato a unirti allo spazio di lavoro %[2]s su Mailwave.",
