...
Privacy-first, cookieless web analytics built in — the [Staminads](https://github.com/staminads) feature set merged into Mailwave, running entirely on PostgreSQL (no ClickHouse, no extra services):
...
- **Lightweight SDK**: ~21 KB gzipped script served by your own Mailwave instance (`/na.js`); the user agent is parsed in the browser, so the raw string is never sent to the server
...
Mailwave follows clean architecture principles with clear separation of concerns:
...
- **[Complete Documentation](https://docs.mailwave.com)** - Comprehensive guides and tutorials

## 🤝 Contributing

**We don't accept pull requests.** Mailwave is developed in-house, and unsolicited pull requests will be closed without review — please don't spend your time on one.

Issues, on the other hand, are very welcome and are the best way to help:

- **[Report a bug](https://github.com/Mailwave/mailwave/issues)** — steps to reproduce, your version, and what you expected instead
- **[Request a feature](https://github.com/Mailwave/mailwave/issues)** — describe the problem you're trying to solve rather than a specific implementation

The licence lets you read, fork and modify Mailwave, and run it in production — including for other people. What it does not let you do is use a licensed feature without a key, or strip out the check. See [LICENSING.md](LICENSING.md).

We do not currently accept pull requests. If we ever invite one, it will be under the [CLA](CLA.md).

## 📄 License

Mailwave v40.0 and later are released under the [Business Source License 1.1](LICENSE),
...
- **Documentation**: [docs.mailwave.com](https://docs.mailwave.com)
- **Email Support**: [hello@mailwave.com](mailto:hello@mailwave.com)
- **GitHub Issues**: [Report bugs or request features](https://github.com/Mailwave/mailwave/issues)
...
**Ready to get started?** [Try the live demo](https://demo.mailwave.com/console/signin?email=demo@mailwave.com) or [deploy your own instance](https://docs.mailwave.com) in minutes.
